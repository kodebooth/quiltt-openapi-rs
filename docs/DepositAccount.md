...
**annual_percentage_yield** | Option<**f64**> | Annual Percentage Yield. If account type = CD, required. | [optional]
...
**maturity_date** | Option<**chrono::DateTime<chrono::FixedOffset>**> | Maturity date for CDs. If account type = CD, required. | [optional]
...
**term** | Option<**i32**> | Term of CD in months | [optional]
