# RemoteAkoyaTransactionDocumentsProductsDdpAkoyaComTransactionsV2ProviderIdAccountIdBodyAnyOfDepositTransaction
...
**check_number** | Option<**i32**> | Check Number | [optional]
...
**payee** | Option<**String**> | Payee name | [optional]
...
**transaction_type** | Option<**TransactionType**> | DepositTransaction Type (enum: CHECK, WITHDRAWAL, TRANSFER, POSDEBIT, ATMWITHDRAWAL, BILLPAYMENT, FEE, DEPOSIT, ADJUSTMENT, INTEREST, DIVIDEND, DIRECTDEPOSIT, ATMDEPOSIT, POSCREDIT) | [optional]
