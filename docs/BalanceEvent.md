...
**r#type** | **Type** | The type of Balance Event that occurred. (enum: balance.created) | [readonly]
**profile** | [**models::AccountEventProfile**](AccountEventProfile.md) |  | 
**record** | [**models::BalanceEventRecord**](BalanceEventRecord.md) |  | 
**metadata** | **serde_json::Value** | Currently there is no metadata available for Balance events. | [readonly]
