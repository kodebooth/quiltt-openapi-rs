...
**interest_rate** | [**models::MortgageInterestRate**](MortgageInterestRate.md) |  | 
...
**maturity_date** | Option<**chrono::NaiveDate**> | Original date on which mortgage is due in full. Dates are returned in an [ISO 8601](https://wikipedia.org/wiki/ISO_8601) format (YYYY-MM-DD). | 
**next_monthly_payment** | Option<**f64**> | The amount of the next payment. | 
**next_payment_due_date** | Option<**chrono::NaiveDate**> | The due date for the next payment. Dates are returned in an [ISO 8601](https://wikipedia.org/wiki/ISO_8601) format (YYYY-MM-DD). | 
...
**property_address** | [**models::MortgagePropertyAddress**](MortgagePropertyAddress.md) |  | 
